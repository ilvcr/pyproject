...
#*************************************************************************#
# File Name: convolution_neural_network.py
# Author: yoghourt->ilvcr 
# Mail: liyaoliu@foxmail.com  @@  ilvcr@outlook.com 
# Created Time: 2018年08月05日 星期日 20时11分47秒
# Description: 
    '''
...
class CNN():
    ...
    def __init__(self, conv1_get, size_p1, bp_num1, bp_num2, bp_num3, rate_w=0.2, rate_t=0.2):
        '''
            :param conv1_get: [a,c,d]ï¼Œsize, number, step of convolution kernel
    ...
    def save_model(self, save_path):
        ...
        print('Model savedï¼š %s'% save_path)
