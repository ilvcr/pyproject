...
# Created Time: 2018年08月01日 星期三 22时29分42秒
# Description: This module contains some useful classes and functions for dealing with linear algebra in python.
#************************************************************************#
...
def axpy(scalar, x, y):
    ...
    '''
    # precondition
    assert(isinstance(x, Vector) and (isinstance(y, Vector)) and (isinstance(scalar,int) or isinstance(scalar,float)))
